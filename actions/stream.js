        ...
        try {
          ...
          if (json_metadata.app !== '{}' && json_metadata.app !== "" && json_metadata.app !== undefined && !isObject(json_metadata.app)) {
            ...
            if (json_metadata.app.includes(dtube_app)) {
              ...
              if ((json_metadata.tags.some(function (r) {
                return tags.indexOf(r) >= 0
              }) && (blacklist.indexOf(result[1].author) === -1)) || (whitelist.indexOf(result[1].author) >= 0)) {
                async.waterfall(
                  [
                    function (callback) {
